...
@endsection
@section('title')
    {{__('translate.schools.add_school')}}
@stop
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{__('translate.schools.add_school')}}</span>
            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1">
                    ...
                    <li class="breadcrumb-item active">{{__('translate.schools.add_school')}}</li>
                </ol>
            </nav>						
        </div>
    </div>
                ...
                <div class="card-body">
                    <form action="{{Route('schools.store')}}" method="post">
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="submit" class="btn btn-primary mt-3">{{__('translate.schools.add_school')}}</button>
                        </div>
                    </form>
                </div>
            </div>
